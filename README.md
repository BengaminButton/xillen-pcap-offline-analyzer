# xillen-pcap-offline-analyzer

Офлайн-анализ PCAP: статистика, топы, аномалии.
...
## Установка
- Клонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-pcap-offline-analyzer.git
- Перейдите в каталог: cd xillen-pcap-offline-analyzer
